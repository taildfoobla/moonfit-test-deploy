...
const MoonBeastItemMinting = ({ isMinting = false }) => {
    return (
        <div className="flex flex-col justify-center items-center mt-4 col-span-2 nft-item animate-pulse">
            <div
                className="item-minting flex justify-center items-center w-full aspect-square bg-gray-300 dark:bg-gray-700 nft-item-image"
            ...
            <div className="item-minting-name flex flex-col normal-case race-sport-font text-sm mt-4">
