...
import MetaMaskLogo from "../../assets/images/deposit/MetaMaskLogo.svg"
import SubWalletLogo from "../../assets/images/deposit/SubWalletLogo.svg"
import WalletConnectLogo from "../../assets/images/deposit/WalletConnectLogo.svg"
...
export const findNetworkFromSymbol = (symbol) =>
    NETWORKS.find((item) => item.symbol === symbol && item.isTestnet === isTestnet)
...
export const WEB3_METHODS = {
    ...
    switchToChainId(chainId,data=null) {
    ...
    addToChainId(chainId,data=null) {
        ...
        if(data===null){
            ...
            console.log("add",{ method: "wallet_addEthereumChain",
            params: [
                {
                    chainId: data.chainHex,
                    rpcUrls: [data.rpc],
