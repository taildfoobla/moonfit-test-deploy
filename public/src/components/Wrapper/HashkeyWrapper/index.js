...
import hashkey1 from "../../../assets/images/hashkey/hashkey-1.png"
import hashkey2 from "../../../assets/images/hashkey/hashkey-2.png"
...
const HashkeyWrapper = ({ children }) => {
    return (
        <div className="hashkey-wrapper">
            ...
            <div className="section-shape hashkey-1 move-vertical">
                <img loading="lazy" src={hashkey1} width="100" height="100" alt="" />
            </div>
            <div className="section-shape hashkey-2 move-vertical-reversed">
                <img loading="lazy" src={hashkey2} width="100" height="100" alt="" />
            </div>
