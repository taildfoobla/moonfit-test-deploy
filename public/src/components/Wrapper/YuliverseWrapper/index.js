...
import beauty2 from "../../../assets/images/valentine/beauty-1.png"
import yuliverse1 from "../../../assets/images/yuliverse/yuliverse-1.png"
import yuliverse2 from "../../../assets/images/yuliverse/yuliverse-2.png"

import "./styles.less"

const YuliverseWrapper = ({ children }) => {
    return (
        <div className="yuliverse-wrapper">
            ...
            <div className="section-shape yuliverse-1 move-vertical">
                <img loading="lazy" src={yuliverse1} width="100" height="100" alt="" />
            </div>
            <div className="section-shape yuliverse-2 move-vertical-reversed">
                <img loading="lazy" src={yuliverse2} width="100" height="100" alt="" />
            </div>
            ...
            {children}
            <div className="footer-yuliverse">
                <Row justify="center">
                    <Col>
...
export default YuliverseWrapper
