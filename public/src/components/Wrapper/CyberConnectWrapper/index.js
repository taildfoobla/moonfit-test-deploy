...
import cyberGreen from "../../../assets/images/cyber-connect/cyber-green.png"
import cyberOrange from "../../../assets/images/cyber-connect/cyber-orange.png"
...
const CyberConnectWrapper = ({children}) => {
    return (
        <div className="advent-onchain-wrapper">
            ...
            <div className="section-shape section-shape-cyber-1 move-vertical">
                <img loading="lazy" src={cyberGreen} width="88" height="88" alt="" />
            </div>
            <div className="section-shape section-shape-cyber-2 move-vertical">
                <img loading="lazy" src={cyberOrange} width="129" height="129" alt="" />
            </div>
            <div className="section-shape section-shape-cyber-3 move-vertical">
                <img loading="lazy" src={cyberGreen} width="88" height="88" alt="" />
            </div>
            <div className="section-shape section-shape-cyber-4 move-vertical">
                <img loading="lazy" src={cyberOrange} width="129" height="129" alt="" />
            </div>
            {children}
            ...
            <div className="footer-advent-onchain">
                <Row justify="center">
                    <Col>
...
export default CyberConnectWrapper
