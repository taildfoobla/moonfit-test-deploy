...
const ChristmasEventWrapper = ({children}) => {
    return (
        <div className="christmas-challenge-wrapper">
            ...
            <div className="footer-christmas-challenge">
                <Row justify="center">
                    <Col>
...
export default ChristmasEventWrapper
