        ...
        info: (
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    ...
                    fill="white"/>
                <path
                    d="M10 11V10.375C10.3956 10.375 10.7822 10.2467 11.1111 10.0063C11.44 9.76597 11.6964 9.42433 11.8478 9.02462C11.9991 8.62491 12.0387 8.18507 11.9616 7.76074C11.8844 7.33641 11.6939 6.94663 11.4142 6.64071C11.1345 6.33478 10.7781 6.12644 10.3902 6.04203C10.0022 5.95763 9.60009 6.00095 9.23463 6.16651C8.86918 6.33208 8.55682 6.61246 8.33706 6.97219C8.1173 7.33192 8 7.75485 8 8.1875"
            ...
            <div className="container">
                <div className="moonfit-card">
                    <div className="moonfit-card-inner">
                        <div
                            className="card-title flex flex-col lg:flex-row lg:justify-between items-start mx-auto mt-0">
                        ...
                        <div className="mp-verify__info">
                            A MoonFit MintPass can be used to mint a maximum of 2 MoonBeasts in this Sale Round. Please
                            enter the MintPass number in the below box to verify their minting eligibility before
                            purchasing.
                        </div>
