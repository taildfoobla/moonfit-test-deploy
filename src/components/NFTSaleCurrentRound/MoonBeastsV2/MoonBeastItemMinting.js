    ...
    return (
        <div className="flex flex-col justify-center items-center mt-4 col-span-2 nft-item animate-pulse">
            ...
            <div className="flex flex-col normal-case race-sport-font text-sm mt-4">
                <span className="secondary-color text-center nft-gender bg-gray-200 rounded dark:bg-gray-700">
                    &nbsp;
                </span>
                <span className="primary-color text-center nft-number-name mt-1 text-center bg-gray-200 rounded dark:bg-gray-700">
                     &nbsp;
                </span>
            </div>
