...
import algem1 from "../../../assets/images/algem/algem-1.png"
import algem2 from "../../../assets/images/algem/algem-2.png"
...
const AlgemWrapper = ({ children }) => {
    return (
        <div className="algem-wrapper">
            ...
            <div className="section-shape algem-1 move-vertical">
                <img loading="lazy" src={algem1} width="100" height="100" alt="" />
            </div>
            <div className="section-shape algem-2 move-vertical-reversed">
                <img loading="lazy" src={algem2} width="100" height="100" alt="" />
            </div>
