...
import beauty1 from "../../../assets/images/valentine/beauty-1.png"
    ...
    return (
        <div className="summer-wrapper">
            ...
            <div className="section-shape section-shape-beauty-1 move-vertical-reversed">
                <img loading="lazy" src={beauty1} width="119" height="119" alt="" />
            </div>
