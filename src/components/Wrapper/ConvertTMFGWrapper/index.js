...
export default function ConvertTMFGWrapper({children}) {
    return (
        <div className="main-content page-content section-hero non-attachment-bg withdraw ">
