...
import astrid1 from "../../../assets/images/astrid/astrid-1.png"
import astrid2 from "../../../assets/images/astrid/astrid-1.png"

import "./styles.less"

const AstridWrapper = ({ children }) => {
    return (
        <div className="astrid-wrapper">
            ...
            <div className="section-shape astrid-1 move-vertical">
                <img loading="lazy" src={astrid1} width="100" height="100" alt="" />
            </div>
            <div className="section-shape astrid-2 move-vertical-reversed">
                <img loading="lazy" src={astrid2} width="100" height="100" alt="" />
            </div>
