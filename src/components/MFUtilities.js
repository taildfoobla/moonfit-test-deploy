    ...
    return (
        <div className="utilities-section">
            ...
            <div className="grid xl:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-8">
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        <div class="block-frame-border"></div>
                        <div class="block-game-feature-content">
                            <div class="block-game-feature-icon">
                                <img loading="lazy" src={flames} alt="Web3Fitness" width="58" height="76" />
                            </div>
                            <h4 class="block-game-feature-title">Web3Fitness</h4>
                            <div class="block-game-feature-description">
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">MoonBeast NFT</h4>
                            <div class="block-game-feature-description">
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">Breeding & MoonEgg NFT</h4>
                            <div class="block-game-feature-description">
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">Leveling System</h4>
                            <div class="block-game-feature-description">Level up your MoonBeast and increase
                                earning chance
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">MoonShop</h4>
                            <div class="block-game-feature-description">Pick and purchase real items with a few
                                taps
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">Marketplace</h4>
                            <div class="block-game-feature-description">Trade your NFTS securely with blockchain
                                technology
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">MoonItem NFT</h4>
                            <div class="block-game-feature-description">Equip your MoonBeasts and boost their
                                abilities
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid-item">
                    <div class="block-game-feature block-frame">
                        ...
                        <div class="block-game-feature-content">
                            ...
                            <h4 class="block-game-feature-title">Clan | Group Training</h4>
                            <div class="block-game-feature-description">Train with friends and have more fun!
                            </div>
                        </div>
                    </div>
                </div>
