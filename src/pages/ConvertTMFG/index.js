    ...
    const handleChange = (e) => {
        ...
        if (num > tmfgValue) {
          length=tmfgValue.toString().length
           setAmount(
                formatNumber(tmfgValue,tmfgDigit)
            )
        } else {
            if (value.includes(",")) {
                    ...
                    <div className="convert-content">
                        ...
                        <div className="convert-data">
                            <div className="convert-data-header">
                                ...
                                <div className="right">
                                    ...
                                    <span>{tokens.length>0?tokens.find(token=>token.name==="tMFG").value:<LoadingOutlined style={{color:"#FFF"}}/>}</span>
                                </div>
                            </div>
                        ...
                        <div className="convert-data">
                            <div className="convert-data-header">
                                ...
                                <div className="right">
                                    <span>Your Balance: </span>
                                    <span>{tokens.length>0?tokens.find(token=>token.name==="oMFG").value:<LoadingOutlined style={{color:"#FFF"}}/>}</span>
                                </div>
                            </div>
                            <div className="convert-data-content">
                                <div className="left">
