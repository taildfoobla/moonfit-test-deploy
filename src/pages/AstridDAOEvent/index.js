...
import eventPool from "../../assets/images/astrid/event-pool.png"
...
import "./styles.less"
import AstridWrapper from "../../components/Wrapper/AstridWrapper"
...
const AstridEvent = () => {
    ...
    useEffect(() => {
        document.title = "MoonFit x AstridDAO Challenge"
    }, [])
    ...
    return (
        <AstridWrapper>
            ...
            <div className="calendar-astrid-container">
                <div className="title">
                    <h2 className="">MoonFit x Astriddao challenge</h2>
                            ...
                            <div className="notify d-flex">
                                <p>
                                    ...
                                    <a
                                        ...
                                        style={{color: "#4CCBC9", textDecoration: "underline"}}
                                    >
                                        here
                                    </a>
                                </p>
                            ...
                            <div className="notify d-flex">
                                <p>
                                    <Tooltip
                                        ...
                                        color="#ecad3e"
                                        style={{color: "#ffffff"}}
                                        overlayClassName="astrid-tooltip"
                ...
                <div className="calendar">
                    <div className="calendar-border">
                        <div className="month">
                            <h3 className="text-astrid">MoonFit x AstridDAO Challenge</h3>
    ...
    return (
        <div key={`fir_${index}`}>
            <MFModal
                ...
                width={470}
                footer={false}
                className={`astrid-event-tasks-modal`}
