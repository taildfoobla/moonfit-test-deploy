...
import eventTitle from "../../assets/images/yuliverse/event-title.png"
import eventPool from "../../assets/images/yuliverse/event-pool.png"
import subEventPool from "../../assets/images/yuliverse/sub-event-pool.png"
...
import "./styles.less"
import YuliverseWrapper from "../../components/Wrapper/YuliverseWrapper"

const YuliverseEvent = () => {
    ...
    useEffect(() => {
        document.title = "MoonFit x Yuliverse Challenge"
    }, [])
    ...
    return (
        <YuliverseWrapper>
            ...
            <div className="calendar-yuliverse-container">
                <div className="title">
                    <img src={eventTitle} alt="title" style={{maxWidth: "655px"}} />
                    <div className="event-pool">
                        <img src={eventPool} alt="pool" style={{maxWidth: "933px"}} />
                        <img className="sub-event-pool" src={subEventPool} alt="sub-pool" />
                    </div>
                            ...
                            <div className="notify d-flex">
                                <p>
                                    ...
                                    <a
                                        ...
                                        style={{color: "#4DFFF6", textDecoration: "underline"}}
                                    >
                                        here
                                    </a>
                                </p>
                            ...
                            <div className="notify d-flex">
                                <p>
                                    <Tooltip
                                        ...
                                        color="#A16BD8"
                                        style={{color: "#ffffff"}}
                                        overlayClassName="yuliverse-tooltip"
                ...
                <div className="calendar">
                    <div className="calendar-border">
                        <div className="month">
                            <h3 className="text-yuliverse">MoonFit x Yuliverse Challenge</h3>
    ...
    return (
        <div key={`fir_${index}`}>
            <MFModal
                ...
                width={470}
                footer={false}
                className={`yuliverse-event-tasks-modal`}
