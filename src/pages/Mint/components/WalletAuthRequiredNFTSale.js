...
import mfBrand from "../../../assets/images/mint/brand.png"
// import WalletAuthContext from "../contexts/WalletAuthContext"
import { useAuth } from '../../../core/contexts/auth'
// import { CountdownComponent } from "./CountdownComponent"
import { CountdownComponent } from '../../Deposit/components/CountdownComponent'
// import { NFT_SALE_CURRENT_INFO } from "../constants/blockchain"
import { NFT_SALE_CURRENT_INFO } from '../../../core/constants-app/blockchain'
import calendar from "../../../assets/images/mint/calendar.svg"
import outlook from "../../../assets/images/mint/outlook.svg"
import yahoo from "../../../assets/images/mint/yahoo.svg"
import office365 from "../../../assets/images/mint/office365.svg"
import wallet from "../../../assets/images/mint/Wallet.svg"
import calendarCheck from "../../../assets/images/mint/CalendarCheck.svg"
...
const WalletAuthRequiredNFTSale = ({ children, className }) => {
    const {auth, showConnectModal} = useAuth()
    ...
    const _renderCountdown = () => {
        if (isStarted) {
            ...
            return <div className="mint-button flex justify-center">
                <button
                    className="button button-secondary btn-join-whitelist" type="button"
                    onClick={showConnectModal}>JOIN WHITELIST SALE</button>
            </div>
        }
    ...
    const renderContent = () => {
        ...
        //     <div className={'mint-header flex flex-col landing-text-wrap justify-center z-[9]'}>
        //         <div className="mint-header-title  lg:hidden flex brand-image justify-center">
        ...
        //             <RenderIdioms />
        //             <div className={' mint-connect flex items-center mt-8 justify-center '}>
        //                 {_renderCountdown()}
        //             </div>
        //         </div>
        //         {
