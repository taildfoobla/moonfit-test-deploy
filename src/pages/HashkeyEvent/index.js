...
import eventTitle from "../../assets/images/hashkey/title.png"
...
import HashkeyWrapper from "../../components/Wrapper/HashkeyWrapper"
...
const HashkeyEvent = () => {
    ...
    useEffect(() => {
        document.title = "MoonFit x Hashkey Did Challenge"
    }, [])
    ...
    return (
        <HashkeyWrapper>
            ...
            <div className="calendar-hashkey-container">
                <div className="title">
                    <h2>
                        MoonFit x Hashkey Did <span className="hashkey-text-stroke">Challenge</span>
                    </h2>
                            ...
                            <div className="notify d-flex">
                                <p>
                                    ...
                                    <a
                                        ...
                                        style={{color: "#EB7F55", textDecoration: "underline"}}
                                    >
                                        here
                                    </a>
                                </p>
                            ...
                            <div className="notify d-flex">
                                <p>
                                    <Tooltip
                                        ...
                                        color="#EB7F55"
                                        style={{color: "#000000"}}
                                        overlayClassName="hashkey-did-tooltip"
                ...
                <div className="calendar">
                    <div className="calendar-border">
                        <div className="month">
                            <h3 className="text-hashkey">MoonFit x HashKey Did Challenge</h3>
    ...
    return (
        <div key={`fir_${index}`}>
            <MFModal
                ...
                width={470}
                footer={false}
                className={`hashkey-event-tasks-modal`}
