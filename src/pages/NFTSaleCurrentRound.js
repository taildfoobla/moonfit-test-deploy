...
const NFTSaleRoundTwo = (props) => {
    ...
    const handleMintNFT = async () => {
        ...
        try {
            ...
            const value = new BigNumber(NFT_SALE_CURRENT_INFO.price).multipliedBy(selectedMp.length).multipliedBy(NFT_SALE_CURRENT_INFO.nftPerPass).multipliedBy(1e18)
                                                    ...
                                                    <div className={'card-body-row flex flex-col'}>
                                                        ...
                                                        <div className={'flex flex-col'}>
                                                            <div className="flex justify-between items-center">
                                                                <div className={'text-[#4ccbc9]'}>{NFT_SALE_CURRENT_INFO.price} GLMR</div>
                                                            </div>
                                                        </div>
                                                        <hr className={'card-body-separator'}/>
