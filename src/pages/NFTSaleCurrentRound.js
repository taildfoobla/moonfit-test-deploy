...
const NFTSaleCurrentRound = (props) => {
    ...
    const fetchData = async (loading = true) => {
        ...
        const mintPasses = await Promise.all(range(0, mpBalance - 1).map(async i => {
            ...
            const outOfSlot = availableSlots <= 0
    ...
    const handleMintNFT = async () => {
        ...
        try {
            ...
            console.log('getReadySale', await nftSaleContract.methods.getReadySale().call(), 'SSSS');
    ...
    const renderMintPasses = () => {
        ...
        const renderMintPasseUsed = (mintPass) => {
            if (mintPass.outOfSlot || !mintPass.bought) {
                return null
            }
        ...
        const _render = mintPasses.map((mp, idx) => {
            ...
            return (
                <div
                    className={classNames('flex flex-col justify-center items-center mt-4 col-span-2 mp-item', {
                        'cursor-not-allowed': mp.outOfSlot,
                        'mp-used': mp.isUsed,
                    })}
                    key={idx}
                    onClick={onClick}>
    ...
    const renderMoonBeasts = () => {
        if (moonBeasts.length === 0 && !mbLoading) {
            return (
                <div className={'my-3'}>
                ...
                <div className={'flex flex-col'}>
                    <div className={'flex justify-center'}>
                        <h2 className={'font-bold text-3xl secondary-color'}>NFT Sale <span
                            className={'text-white'}>Round #{NFT_SALE_CURRENT_INFO.number}</span></h2>
                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <a href="#" className={'normal-case text-xs inline primary-color'}
                                       onClick={() => fetchData()}>
                                        <svg className="w-4 h-4 inline mr-1" fill="none"
                                             stroke="currentColor"
                                             viewBox="0 0 24 24"
                                ...
                                <div className={'mt-4 mb-6 lg:mt-8'}>
                                    <div className={'card-body-row flex flex-col'}>
                                        ...
                                        <div className={'flex justify-between items-center mt-2'}>
                                            <div className={'flex card-body-row-title'}>Total Minted
                                            </div>
                                            {
                                                availableSlots > 0 ? (
                                                    <div
                                    ...
                                    <div className={'card-body-row flex flex-col mt-3'}>
                                        <div className="flex justify-between">
                                            <div className={'flex card-body-row-title'}>Select A Pass to
                                                Mint
                                            </div>
                                            <div
                                    ...
                                    <div className={'card-body-row flex flex-col mt-3'}>
                                        <div className="flex justify-between">
                                            <div className={'flex card-body-row-title'}>Your minted NFTs
                                            </div>
                                            <div
