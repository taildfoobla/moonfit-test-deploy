...
import eventTitle from "../../assets/images/algem/title.png"
...
import AlgemWrapper from "../../components/Wrapper/AlgemWrapper"
...
const AlgemEvent = () => {
    ...
    useEffect(() => {
        document.title = "MoonFit x Algem Challenge"
    }, [])
    ...
    return (
        <AlgemWrapper>
            <MFModal
                ...
                width={600}
                footer={false}
                className={`algem-event ${reward?.type === "token" ? "modal-reward-token-container" : "modal-reward-item-container"
                    }`}
                maskClosable={false}
            ...
            <div className="calendar-algem-container">
                <div className="title">
                    <h2>MoonFit x Algem Challenge</h2>
                        ...
                        <div className="list-event-notification">
                            <div className="notify d-flex">
                                <p>
                                    ...
                                    <a href="https://onelink.to/kqzrmx" target="_blank" rel="noreferrer noopener" style={{ color: "#4DFFF6", textDecoration: 'underline' }}>
                                        here
                                    </a>
                                </p>
                            </div>
...
const AuthCalendar = ({ loading, task, index, refetch, openModal, setReward, setOpenModal }) => {
    ...
    const checkCurrentTask =
        getCurrentNowDate() === getDayOfMonth(task?.date) && now.year() === 2023
    ...
    return (
        <div key={`fir_${index}`}>
            <MFModal
                ...
                width={470}
                footer={false}
                className={`algem-event-tasks-modal`}
