...
const ChristmasEvent = () => {
    ...
    useEffect(() => {
        document.title = "MoonFit - Christmas Challenge"
    }, [])
    ...
    return (
        <ChristmasEventWrapper>
            ...
            <div className="calendar-christmas-challenge-container">
                <div className="christmas-challenge-header">
                 <img src={christmasChallengeHeader} alt=""/>
                 <img src={christmasChallengePrize} alt=""/>
                </div>
                <div className="title">
                        ...
                        {/* <div className="notify d-flex">
                            ...
                            <div className="notify d-flex">
                                <p>
                                    ...
                                    <span style={{color: "#4DFFF6"}}>#LunarGamingFestival #xmaschallenge</span>
                                </p>
                            </div>
                            <div className="notify d-flex">
                                <p>
    ...
    return (
        <div key={`fir_${index}`}>
            <MFModal
                ...
                width={470}
                footer={false}
                className={`christmas-challenge-modal`}
